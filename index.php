        ...
        <div class="page-container">
						...
						<div class="col-md-6">
					     ...
					     <div class="panel panel-default">                            
                                <div class="panel-body panel-body-image">
                                    <img src="assets/images/googleanalytics.jpg" alt="Ocean"/>
                                     <p class="panel-body-inform">
                                        <span class="fa fa-area-chart"></span>
                                    </p>
                                </div>
                                <div class="panel-body">
                                    <h3>Google Analytics &mdash; Web Analytics</h3>
			...
			<!-- Widget GTMETRIX -->
						<div class="col-md-6">
					     ...
					     <div class="panel panel-default">                            
                                <div class="panel-body panel-body-image">
                                    <img src="assets/images/gtmetrix.jpg" alt="Ocean"/>
                                    <p class="panel-body-inform">
                                        <span class="fa fa-line-chart"></span>
                                    </p>
                                </div>
                                <div class="panel-body">
                                    <h3>GTMetrix &mdash; Site Performance</h3>
                                    <p>GTMetrix is one of the tools that we have found ourselves using more and more to get detailed reports about our site's performance.</p>
                                </div>
